...
<div id='sign'>
    ...
    <form onSubmit={(e)=>{signIn(e)}}>
        ...
        <input type='text' placeholder="name"  name='sign'/><br/>
...
<h4>Log In</h4>
<button onClick={()=>{setlog(1)}}>Login</button>
{
(log && <form onSubmit={(e)=>{logIn(e)}}>
    <input type='text' placeholder='email' name='log'/><br/>
